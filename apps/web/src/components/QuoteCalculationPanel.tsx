...
export default function QuoteCalculationPanel({
  ...
  const requiresRuralConfirmation = Boolean(ruralConfirmationRequired);
  ...
  return (
    <section className="panel min-w-0 p-4">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 xl:grid-cols-3">
        ...
        <Metric label="报价合计" value={hasTotalPrice && !manualRequired ? formatMoney(totalPrice, currency) : manualRequired ? manualPriceText : "待计算"} />
